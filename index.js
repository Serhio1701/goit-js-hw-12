import{a as g,S as h,i as c}from"./assets/vendor-C2ySes1p.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const b="https://pixabay.com/api/",L="54018968-920e73cf119f2d437152d8f97";async function S(n,r=1){return(await g.get(b,{params:{key:L,q:n,image_type:"photo",orientation:"horizontal",safesearch:!0,page:r,per_page:40}})).data}const a=document.querySelector(".gallery"),d=document.querySelector(".loader"),q=new h(".gallery a",{captionsData:"alt",captionDelay:250});function w(n){if(!a)return;const r=n.map(({webformatURL:o,largeImageURL:i,tags:e,likes:t,views:s,comments:m,downloads:y})=>`
